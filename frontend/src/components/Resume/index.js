    ...
    <div className="resume-section">
      ...
      <div className="resume-body">
        ...
        <ul className="resume-list">
          ...
          <li>
            Work in teams of 3-4 with client to develop marketing materials such as promotional photos, social media campaigns, Kickstarter campaigns, website and mass
